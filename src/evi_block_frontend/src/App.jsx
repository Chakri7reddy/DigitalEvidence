  ...
  const teamMembers = [
    {
      ...
      description:
        "Enjoys designing secure, scalable systems on the blockchain.",
      photo: "chakri Photo.jpg",
      links: {
    ...
    <main className="app-wrapper">
            ...
            {activeCard === "upload" && (
              <div className="card upload-card">
                <div className="card-bg">
                  <Particles
                    particleColors={["#2452ff", "#92c5ff"]}
                    particleCount={300}
                    particleSpread={10}
                    speed={0.1}
                    particleBaseSize={290}
                ...
                <div className="card-content">
                  ...
                  {uploadResponse && (
                    <p className="response-msg">{uploadResponse}</p>
                  )}
                </div>
              </div>
            )}
            ...
            {activeCard === "verify" && (
              <div className="card verify-card">
                ...
                <div className="card-content">
                  ...
                  {verifyResponse && (
                    <p className="response-msg">{verifyResponse}</p>
                  )}
                </div>
              </div>
            )}
      ...
      {activePage === "about" && (
        <div className="about-page">
          <h2>About Us</h2>
          <p>
            Eviblock is a blockchain-based digital evidence verification
            platform. Upload and verify the authenticity of your files using
            decentralized trust.
          </p>
          <p>
            This tool ensures a tamper-proof chain of custody for files related
            to cybercrime and legal evidence handling. Built with security,
            simplicity, and transparency in mind.
          </p>
